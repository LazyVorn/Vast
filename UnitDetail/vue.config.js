...
module.exports = {
    ...
    // 那么将这个值改为 `/my-app/`
    baseUrl: '/frame/UnitDetail',

    // 将构建好的文件输出到哪里
    outputDir: 'dist/UnitDetail',
    ...
    configureWebpack: config => {
        if (process.env.NODE_ENV === 'production') {
            ...
            return {
                plugins: [
                    new OpenBrowserPlugin({ url: 'http://localhost:' + theDefaultPort + '/index.html#/7/UnitDetail', browser: 'chrome' }),
                ],
            }
            // 为开发环境修改配置...
        }
